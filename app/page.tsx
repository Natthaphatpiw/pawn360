...
export default function Home() {
  return (
    <div className={`${notoSansThai.className} bg-background text-foreground`}>
      {/* Hidden element to load Bellota Text font */}
      ...
      <div className="relative overflow-hidden">
              ...
              <div className="flex h-full w-full max-w-[100vw] flex-col bg-background-dark p-6 shadow-strong lg:w-[min(92vw,360px)] lg:max-w-[min(92vw,360px)] lg:rounded-[28px] lg:min-h-0">
                ...
                <div className="mt-8 flex-1 overflow-y-auto">
                  <div className="space-y-2 text-s1">
                    <div className="rounded-2xl bg-primary px-4 py-3 text-md text-primary-fg">หน้าหลัก</div>
                    <Link
                      href="/pawner"
        ...
        <section className="mx-auto grid w-full max-w-[1216px] items-center gap-12 px-4 pb-24 pt-16 sm:px-6 sm:pb-28 lg:grid-cols-[1.1fr_0.9fr] lg:px-14">
          <div className="fade-up reveal-left text-center lg:text-left">
            ...
            <h1 className="text-3xl font-extralight leading-[1.5] text-foreground sm:text-4xl lg:text-[50px]">
              ...
              <br />ของคุณ ด้วยเทคโนโลยี <span className="text-primary font-medium font-english">AI</span>
            ...
            <div className="mt-6 flex flex-col items-stretch gap-3 sm:flex-row sm:items-center sm:justify-center lg:justify-start">
              <Link href="/pawner">
                <button className="w-full rounded-full border border-primary bg-transparent px-6 py-2 text-sm text-primary transition-all duration-200 hover:bg-primary hover:text-primary-fg sm:w-auto cursor-pointer">
                  ต้องการเงินทุน (<span className="font-english">Start Borrowing</span>)
                </button>
              </Link>
              <Link href="/investor">
                <button className="w-full rounded-full border border-primary bg-transparent px-6 py-2 text-sm text-primary transition-all duration-200 hover:bg-primary hover:text-primary-fg sm:w-auto cursor-pointer">
                  สนใจลงทุน (<span className="font-english">Start Investing</span>)
                </button>
              </Link>
            </div>
          </div>
          ...
          <div className="relative flex flex-col items-center">
            ...
            <div className="fade-up relative z-0 mx-auto -mt-10 w-full max-w-[1216px] rounded-[40px] border border-primary-border bg-primary-soft px-4 pb-10 pt-12 text-center text-s1 sm:-mt-16 sm:px-12 sm:pt-16 lg:-mt-20">
              <h2 className="text-2xl font-base sm:text-3xl lg:text-[40px] font-english">
                What is <span className="text-primary font-semibold font-english">Pawnly</span>?
              </h2>
              ...
              <Link href="/about" className="mt-6 inline-block">
                <button className="mt-6 inline-flex items-center justify-center rounded-full border border-primary bg-transparent px-6 py-2 text-sm text-primary transition-all duration-200 hover:scale-100 hover:bg-primary hover:text-primary-fg cursor-pointer">
                  อ่านเพิ่มเติม
        ...
        <section className="mx-auto w-full max-w-[1216px] px-4 pb-24 text-center sm:px-6 sm:pb-28 lg:px-14">
          <div className="fade-up">
            <h3 className="text-xl font-medium text-s1 sm:text-[36px] font-english">Our Three Pillars</h3>
            <p className="mt-1 text-lg text-foreground-subtle font-english">Our services/Solutions</p>
          </div>
            ...
            {[
              ...
              <Link key={item.href} href={item.href}>
                <Image
                  src={item.src}
                  alt={item.alt}
                  className="h-auto w-full rounded-[24px] shadow-soft hover:scale-105 hover:shadow-strong transition-all duration-300 cursor-pointer"
                />
              </Link>
            ))}
          </div>
        ...
        <section className="py-16 sm:py-20">
          <div className="mx-auto w-full bg-background-dark px-4 py-15 text-center text-s1 sm:px-6 lg:px-14">
            ...
            <div className="mx-auto flex w-full items-center mt-4 grid gap-6 sm:mt-6 sm:grid-cols-2 lg:mt-8 lg:grid-cols-3 max-w-[1216px]">
              {[
                {
                  title: 'Safety First',
                ...
                },
                {
                  ...
                  thaiDesc: 'ทรัพย์สินทุกชิ้นผ่านการตรวจสอบอย่างละเอียดโดยทีมผู้เชี่ยวชาญเฉพาะทาง ร่วมกับเทคโนโลยี AI ที่ทันสมัย เพื่อให้มั่นใจในความแม่นยำและการประเมินมูลค่าที่เป็นธรรมตามราคาตลาด',
                  icon: (
                    <svg width="64" height="68" viewBox="0 0 64 68" fill="none" xmlns="http://www.w3.org/2000/svg">
                      <path d="M0 34C0 16.3269 14.3269 2 32 2C49.6731 2 64 16.3269 64 34C64 51.6731 49.6731 66 32 66C14.3269 66 0 51.6731 0 34Z" fill="none"/>
                ...
                },
                {
                  ...
                  thaiDesc: 'ทุกสัญญาจัดทำอย่างถูกต้องตามกฎหมายและมีความโปร่งใสสูงสุด คุณสามารถติดตามสถานะทรัพย์สิน รายละเอียดสินเชื่อ และกำหนดการชำระเงินได้แบบเรียลไทม์ผ่าน Line OA',
                  icon: (
                    <svg width="64" height="64" viewBox="0 0 64 64" fill="none" xmlns="http://www.w3.org/2000/svg">
                      <path d="M0 32C0 14.3269 14.3269 0 32 0C49.6731 0 64 14.3269 64 32C64 49.6731 49.6731 64 32 64C14.3269 64 0 49.6731 0 32Z" fill="none"/>
                      <path d="M17 19.75V32C17 44.25 32 49.5 32 49.5C32 49.5 47 44.25 47 32V19.75L32 14.5L17 19.75Z" stroke="currentColor" strokeWidth="3.33333" strokeLinecap="square"/>
                      <path d="M25.6211 30.62L30.3328 35.3334L39.7611 25.905" stroke="currentColor" strokeWidth="3.33333" strokeLinecap="square"/>
                    </svg>
                  ),
                },
              ].map((item, index) => (
                <div
                  key={item.title}
                  className={`font-english fade-up rounded-[28px] bg-background-darker px-4 py-6 transition-all duration-200 hover:scale-[1.0] ${
                ...
                >
                  ...
                  <p className="mt-2 text-sm text-foreground-subtle font-english font-base">{item.desc}</p>
                  {item.thaiDesc && <p className="mt-1 text-sm text-foreground-subtle font-light">{item.thaiDesc}</p>}
                </div>
              ))}
            </div>
          </div>
              ...
              <div className="grid gap-8 grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 text-xs text-center lg:text-left w-full justify-items-center lg:justify-items-start">
                ...
                <div className="w-full">
                  ...
                  <ul className="mt-3 space-y-2">
                    <li><Link href="/home" className="text-foreground-subtle transition-colors hover:text-primary">หน้าหลัก</Link></li>
                    <li><Link href="/borrowers" className="text-foreground-subtle transition-colors hover:text-primary">ผู้ขอสินเชื่อ</Link></li>
                    <li><Link href="/investors" className="text-foreground-subtle transition-colors hover:text-primary">นักลงทุน</Link></li>
                    <li><Link href="/branches" className="text-foreground-subtle transition-colors hover:text-primary">จุดรับฝาก</Link></li>
                  </ul>
                </div>
