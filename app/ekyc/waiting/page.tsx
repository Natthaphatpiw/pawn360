    ...
    const pollKYCStatus = async () => {
      ...
      try {
        ...
        if (response.data.exists) {
          ...
          } else if (pawner.kyc_status === 'REJECTED') {
      ...
      <div className="min-h-screen bg-white font-sans p-4 flex flex-col items-center justify-center">
        <div className="w-full max-w-md text-center">
          ...
          <button
            ...
            className="w-full bg-[#B85C38] hover:bg-[#A04D2D] text-white font-bold py-4 rounded-2xl transition-all shadow-sm active:scale-[0.98]"
          >
      ...
      <div className="w-full max-w-md text-center">
        ...
        <div className="flex justify-center mb-6">
          <div className="relative">
            <div className="w-24 h-24 border-4 border-[#F9EFE6] rounded-full"></div>
            <div className="absolute top-0 left-0 w-24 h-24 border-4 border-[#C0562F] border-t-transparent rounded-full animate-spin"></div>
        ...
        {/* Timer */}
        <div className="bg-white border-2 border-[#C0562F] rounded-xl p-4 mb-4">
          <div className="text-xs text-gray-500 mb-1">เวลาคงเหลือ</div>
          <div className="text-3xl font-bold text-[#C0562F] font-mono">
            {formatTime(timeLeft)}
          </div>
        </div>
