          ...
          <div className="fade-up reveal-left text-center sm:text-left lg:pt-6">
            ...
            <div className="mt-5 flex flex-wrap justify-center sm:justify-start">
              <a
                ...
                target="_blank"
                rel="noreferrer"
                className="btn-sheen rounded-full border border-[var(--accent)] px-6 py-2 text-sm text-[var(--accent)] shadow-[0_8px_18px_rgba(197,81,37,0.25)] transition-colors duration-300 hover:bg-[var(--accent)] hover:text-white sm:px-9 sm:py-4 sm:text-[16px] cursor-pointer"
              >
                เริ่มเลย!
              </a>
            </div>
