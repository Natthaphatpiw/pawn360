      ...
      <div className="max-w-md mx-auto rounded-xl border border-primary-border/60 bg-primary-soft/50 py-6 px-4">
        ...
        <div className="bg-background-white rounded-lg p-6 mb-6 max-h-96 overflow-y-auto text-sm text-foreground-muted leading-relaxed border border-primary/50">
          ...
          <ol className="list-decimal list-inside space-y-2 mb-4">
            ...
            <li>ข้าพเจ้ายอมรับในเงื่อนไขและข้อกำหนดของแพลตฟอร์ม Astly</li>
          </ol>

          <h3 className="font-bold mb-2">เงื่อนไขการขอสินเชื่อ:</h3>
          <ul className="list-disc list-inside space-y-1 mb-4">
            <li>อัตราดอกเบี้ยคำนวณแบบรายวัน</li>
            <li>ค่าธรรมเนียมการขอสินเชื่อ 1.5% ของวงเงิน (คำนวณจากวงเงินเริ่มต้นของสัญญา)</li>
            <li>ระยะเวลาในการไถ่ถอนสินค้าตามที่กำหนด</li>
            <li>สินค้าจะถูกเก็บไว้ที่ Drop Point เป็นเวลา 15 วันนับจากวันเริ่มสัญญา หลังจากนั้น Astly จะย้ายสินค้าไปเก็บที่คลังกลาง</li>
            <li>
              หากต้องการไถ่ถอนแบบไม่เสียค่าใช้จ่ายเพิ่มเติม กรุณาวางแผนล่วงหน้าอย่างน้อย 7 วัน หรือเลือกรับของที่คลังกลาง
              และหากต้องการรับของภายในวันถัดไป จะมีค่าดำเนินการเพิ่มเติม 100 บาท
            </li>
            <li>เมื่อครบกำหนดสัญญาแล้วและยังไม่ได้ไถ่ถอน จะมีค่าปรับวันละ 100 บาท นับตามจำนวนวันที่เกินกำหนดจริง</li>
          </ul>
