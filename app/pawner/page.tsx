      ...
      <div className="relative overflow-hidden">
        ...
        <section className="relative overflow-hidden bg-background-dark my-12 py-12 sm:py-16">
          <div className="mx-auto w-full max-w-[1216px] px-4 text-center sm:px-6 lg:px-14">
            <div className="mx-auto max-w-[720px]">
              ...
              <p className="mt-2 text-sm text-foreground-subtle sm:text-base">
                ผลประโยชน์ของผู้ขอสินเชื่อ
              </p>
            </div>
        ...
        <section className="mx-auto w-full max-w-[1216px] px-4 py-16 sm:px-6 sm:py-20 lg:px-14">
          <div className="mb-10 text-center">
            <h3 className="text-3xl font-medium text-s1 sm:text-[40px] font-english">How it Works</h3>
            <p className="mt-2 text-sm text-foreground-subtle sm:text-base">4 ขั้นตอนง่ายๆ</p>
          </div>
