          ...
          <div className="flex gap-3">
            ...
            <div>
              ...
              <ul className="text-xs text-red-600 space-y-1 list-disc list-inside">
                ...
                <li>ทาง Astly จะไม่รับผิดชอบความผิดพลาดที่เกิดจากผู้ใช้งาน</li>
              </ul>
            </div>
          </div>
        </div>
        ...
        <div className="bg-background-white rounded-xl p-4 mb-4">
          ...
          <label className="checkbox flex items-start gap-3 cursor-pointer">
            ...
            <div className="text-sm text-foreground-muted">
              ข้าพเจ้ารับทราบและยอมรับว่าหากโอนเงินเกินหรือขาดไม่ตรงตามจำนวน ทาง Astly จะไม่รับผิดชอบใดๆ ทั้งสิ้น และการดำเนินการอาจถูกยกเลิก ข้าพเจ้าได้ตรวจสอบยอดเงินและข้อมูลการโอนเงินเรียบร้อยแล้ว
            </div>
          </label>
        </div>
