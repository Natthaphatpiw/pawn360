    ...
    return (
      <div className="min-h-screen bg-[#F2F2F2] font-sans flex flex-col items-center justify-center p-6">
        <div className="bg-white rounded-3xl p-8 text-center shadow-lg max-w-sm w-full">
          ...
          <h1 className="text-xl font-bold text-gray-800 mb-2">ต่อดอกเบี้ยสำเร็จ</h1>
    ...
    <div className="min-h-screen bg-[#F2F2F2] font-sans flex flex-col">
      ...
      <div className="bg-white px-4 py-3 flex items-center shadow-sm sticky top-0 z-10">
        ...
        <div className="flex-1 text-center">
          <h1 className="font-bold text-lg text-gray-800">เซ็นสัญญาต่อดอกเบี้ย</h1>
          <p className="text-xs text-gray-400">Sign Extension Contract</p>
        </div>
      ...
      <div className="flex-1 flex flex-col items-center p-6 pb-32">
        ...
        {requestDetails && contract && (
          <div className="w-full max-w-sm bg-white rounded-2xl p-4 mb-4 shadow-sm">
            <h3 className="font-bold text-gray-800 mb-3">รายละเอียดการต่อดอกเบี้ย</h3>
        ...
        <div className="max-w-sm mx-auto">
          ...
          >
            {submitting ? (
              ...
              <>
                <span className="text-lg font-bold">ยืนยันต่อดอกเบี้ย</span>
                <span className="text-xs font-light opacity-80">Confirm Extension</span>
              </>
            )}
          </button>
        </div>
